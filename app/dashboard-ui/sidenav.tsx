...
export const signOut = () => {
    ...
    window.location.href = '/'; // Redirect to the onboarding or home page
};
    ...
    return (
        <div className="flex h-full flex-col px-3 py-4 md:px-2">
            ...
            <div className="flex grow flex-row justify-between space-x-2 md:flex-col md:space-x-0 md:space-y-2">
                ...
                <form
                    action={async () => {
                        'use server'; // Ensure this is set for server actions in Next.js
                        await signOut(); // Call signOut on submission
                    }}
                >
