      ...
      <div className="flex-1 flex flex-col items-center justify-center">
        <div className="relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center">
              <p className="text-3xl font-bold text-slate-900 dark:text-white">{approvalPercentage}%</p>
        ...
        <div className="mt-6 flex gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-slate-600 dark:text-slate-300">Approved ({approved})</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded-full bg-slate-300 dark:bg-slate-600"></div>
            <span className="text-sm text-slate-600 dark:text-slate-300">Other ({denied})</span>
          </div>
        </div>
      </div>
    </div>
